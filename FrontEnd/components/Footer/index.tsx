      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/3 lg:w-1/3">
              <div className="mb-12 max-w-[600px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-4 text-base leading-relaxed text-body-color">
                  Công ty TNHH Happy Edu Hub.
                </p>
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Số 7 ngõ 29F đường Đà Nẵng, quận Ngô Quyền, TP Hải Phòng
                </p>
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/3">
              <div className="mb-12 w-[600px] lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                  Thông tin doanh nghiệp
                </h2>
                <ul>
                  <li className="mb-4">
                    <a className="text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary">
                      Mã số thuế: 0202270538
                    </a>
                  </li>
                  <li className="mb-4">
                    <a className="text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary">
                  ...
                  <li className="mb-4">
                    <a className="text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary">
                      Điện thoại trụ sở: 0813 809 696
                    </a>
                  </li>
                </ul>
              </div>
