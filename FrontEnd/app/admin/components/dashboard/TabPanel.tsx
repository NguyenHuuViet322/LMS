...
const TabPanel = ({ tabs, activeTab, setActiveTab, rightButton }: TabPanelProps) => {
            ...
            <nav className="flex space-x-4 relative">
                {tabs.map((tab) => (
                    <button
                        ...
                        `}
                    >
                        {tab.icon && <span className="transition-transform duration-300 ease-in-out">{tab.icon}</span>}
                        <span className="transition-transform duration-300 ease-in-out">{tab.title}</span>
