...
import { SortType, ActionType, Subject, subjectBadgeColors } from '@/app/utils/constant';
              ...
              <Table.Body className="divide-y divide-border dark:divide-darkborder">
                {teacher.map((item, index) => (
                  <Table.Row key={index}>
                    ...
                    <Table.Cell>
                      <Badge color={subjectBadgeColors[subject.find(tag => tag.name == item.additional_teacher_data?.subject.name)?.name as Subject]} className="text-xs font-bold rounded-lg">{item.additional_teacher_data?.subject.name}</Badge>
                    </Table.Cell>
                    <Table.Cell>
                      <Dropdown
                        label=""
