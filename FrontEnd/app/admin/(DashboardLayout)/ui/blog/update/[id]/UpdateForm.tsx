      ...
      <div className="flex flex-col">
        <div className="flex gap-6 items-stretch">
          <div className="flex flex-1 flex-col gap-4">
            ...
            <div>
              <div className="flex">
                <Label htmlFor="type" value="Loại bài viết" className="mb-2 block" />
                <RequiredStar />
              </div>
              <Select
                id="type"
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col justify-center">
              <Label htmlFor="thumb" value="Thumbnail" className="mb-2 block" />
              <div className="flex">
                <Label className={`${(!thumbFile && !values.thumb) ? "rounded-lg" : "rounded-l-lg"} h-full flex flex-1 w-full cursor-pointer flex-col items-center justify-center border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-500 dark:hover:bg-gray-600`}>
                  ...
                  {(thumbFile || values.thumb) && (
                    <div className="flex w-full justify-between items-center h-32">
                      <img
                        src={thumbFile ? URL.createObjectURL(thumbFile) : processGoogleDriveLink(values.thumb)}
        ...
        <div className="my-4">
          <div className="flex">
            <Label htmlFor="content" value="Nội dung bài viết" className="mb-2 block" />
            <RequiredStar />
          </div>
          <ReactQuill
            theme="snow"
