                  ...
                  <Table.Row key={index}>
                    <Table.Cell className="whitespace-nowrap ps-6">
                      <div className="flex gap-3 items-center group relative">
                        <BlogImage
                          thumbnail_url={processGoogleDriveLink(item.thumbnail_url)}
                          title={undefined}
                        />

                        <div className="truncat line-clamp-2 sm:text-wrap max-w-56 cursor-pointer" onClick={() => router.push(`/admin/ui/blog/detail/${item.id}`)}>
