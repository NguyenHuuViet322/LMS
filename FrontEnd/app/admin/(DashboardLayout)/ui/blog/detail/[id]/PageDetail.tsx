  ...
  return (
    <div className='flex flex-col rounded-lg shadow-md bg-white dark:bg-darkgray w-full'>
      <div className='relative'>
        <img
          src={imageSrc == '/images/default.png' ? imageSrc : processGoogleDriveLink(imageSrc)}
          alt="Thumbnail"
      ...
      <h3 className='text-sm text-gray-500 mx-4'>{blog?.author.name + " - " + formattedDate(blog?.created_at)}</h3>
