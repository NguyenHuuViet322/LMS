          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              <div className="lg:col-span-6 col-span-12 mb-2 block">
                <Label htmlFor="address" value="Trường hiện đang theo học" className="mb-2" />
                <RequiredStar />
              </div>
              {values.is_thaiphien && (<TextInput
                id="school"
                name="school"
                type="text"
            ...
            <div>
              <div className="mb-2 block">
                <Label htmlFor="class" value="Lớp học tại trường" className="mb-2" />
                <RequiredStar />
              </div>
              <TextInput
                id="class"
