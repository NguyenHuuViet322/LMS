...
export const APIS = {
  getCourses: async (params: {
    ...
    const queryString = new URLSearchParams({ limit: params.limit.toString(), offset: params.offset.toString() }).toString();
  ...
  getMembersByCourseId: async (courseId: number, params: {
    limit: number;
    offset: number;
    filter?: {
      role: string;
    ...
    const query: any = { limit: params.limit.toString(), offset: params.offset.toString() };
