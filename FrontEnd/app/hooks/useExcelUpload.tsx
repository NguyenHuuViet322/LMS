...
const useExcelUpload = (onUploadSuccess) => {
    ...
    reader.onload = async (e) => {
      try {
        ...
        const expectedHeaders = [
          "Họ tên học sinh", "Lớp", "Trường", "Email", "Giới tính", "Họ tên phụ huynh 1",
          "CCCD", "Ngày cấp", "SĐT phụ huynh 1", "Họ tên phụ huynh 2 (optional)",
          "SĐT phụ huynh 2 (optional)", "Địa chỉ", "Ghi chú", "Giáo viên chủ nhiệm (nếu là học sinh thái phiên)"
        ];
        ...
        const filteredData = jsonData.slice(2)
  ...
  return { fileInputRef, handleClickImport, handleFileUpload, loading, formattedData, validateFinalData };
};
