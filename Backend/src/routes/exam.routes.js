 ...
 *       - Token: []
 */
examRoutes.post("/exam", authMiddleware, roleMiddleware([ROLE.ADMIN, ROLE.TEACHER]), examController.create);
 ...
 *       - Token: []
 */
examRoutes.get("/exam/get-all", authMiddleware, roleMiddleware([ROLE.ADMIN]), examController.findAll);
 ...
 *       - Token: []
 */
examRoutes.delete("/exam/:id", authMiddleware, roleMiddleware([ROLE.ADMIN, ROLE.TEACHER]), examController.delete);
