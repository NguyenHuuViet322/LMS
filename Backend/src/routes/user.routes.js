 ...
 *       - Token: []
 */
userRoutes.post("/user/create-by-admin", authMiddleware, roleMiddleware([ROLE.ADMIN]), userController.addByAdmin);
 ...
 *       - Token: []
 */
userRoutes.put("/user/:id/update-by-admin", authMiddleware, roleMiddleware([ROLE.ADMIN]), userController.updateByAdmin);
 ...
 *       - Token: []
 */
userRoutes.post("/user/bulk-student-create", authMiddleware, roleMiddleware([ROLE.ADMIN]), userController.bulkStudentCreate);
