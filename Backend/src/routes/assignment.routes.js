 ...
 *       - Token: []
 */
assignmentRoutes.post("/assignment", authMiddleware, roleMiddleware([ROLE.TEACHER, ROLE.ACADEMIC_AFFAIR]), assignmentController.create);
 ...
 *       - Token: []
 */
assignmentRoutes.put("/assignment/:id", authMiddleware, roleMiddleware([ROLE.TEACHER, ROLE.ACADEMIC_AFFAIR]), assignmentController.update);
 ...
 *       - Token: []
 */
assignmentRoutes.delete("/assignment/:id", authMiddleware, roleMiddleware([ROLE.TEACHER, ROLE.ACADEMIC_AFFAIR]), assignmentController.delete);
